...
<body>
  ...
  <section class="hero">
    ...
    <div class="container hero-content">
      ...
      <p class="hero-subtitle">Overview of the queries.</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="section-header">
        <div>
          ...
          <p class="section-subtitle">Overview of the queries.</p>
        </div>
      </div>

      <ul style="list-style:none; padding:0; display:grid; gap:10px;">
        <li><a class="nav-link" href="./event.php">Event Availability</a></li>
        <li><a class="nav-link" href="./orders.php">Orders by User</a></li>
        <li><a class="nav-link" href="./event_sold_out.php">Sold-Out Events</a></li>
        <li><a class="nav-link" href="./category.php">Category Summary</a></li>
      </ul>
    </div>
  </section>
