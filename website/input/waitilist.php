...
<body>
  ...
  <section class="events-section">
    <div class="container">
      ...
      <form action="../process/waitlist.php" method="post" style="background:#fff;border:1px solid #e5e7eb;border-radius:14px;padding:20px;">
        <div style="display:grid;grid-template-columns:1fr;gap:16px;">
          ...
          <label>
            ...
            <select name="event_id" required class="input" style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
          ...
          <label>
            ...
            <input type="number" min="1" name="seats_requested" required placeholder="2" class="input" style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
          </label>

          <label>
            <span style="display:block;font-weight:700;margin-bottom:6px;">Status *</span>
            <select name="status" required class="input" style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px%;">
          ...
          <label>
            ...
            <input type="datetime-local" name="expires_at" class="input" style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
          </label>
