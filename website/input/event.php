...
<body>
    ...
    <section class="hero">
        ...
        <div class="container hero-content">
            ...
            <p class="hero-subtitle">Add a new event</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <form action="../process/event.php" method="post"
                ...
                <div style="display:grid;grid-template-columns:1fr;gap:16px;">
                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Title *</span>
                        <input type="text" name="title" required placeholder="Karaoke Night" class="input"
                            style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
                    </label>

                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Category</span>
                    ...
                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Start at *</span>
                        <input type="datetime-local" name="start_at" required class="input"
                            style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
                    </label>

                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Description</span>
                        <textarea name="description" rows="4" placeholder="Short description…" class="textarea"
                            style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;"></textarea>
                    </label>

                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Image URL</span>
                        <input type="url" name="img_url" placeholder="https://…" class="input"
                            style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
                    </label>
