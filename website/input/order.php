...
<body>
    ...
    <section class="hero">
        ...
        <div class="container hero-content">
            ...
            <p class="hero-subtitle">Add a new order</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <form action="../process/order.php" method="post"
                ...
                <div style="display:grid;grid-template-columns:1fr;gap:16px;">
                    ...
                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Payment Status *</span>
                    ...
                    <label>
                        <span style="display:block;font-weight:700;margin-bottom:6px;">Total (INT) *</span>
                        <input type="number" step="1" min="0" name="total" required placeholder="100" class="input"
                            style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:10px;">
                    </label>
