...
<body>
  ...
  <section class="hero">
    ...
    <div class="container hero-content">
      <h1 class="hero-title">Autocomplete Demo</h1>
      <p class="hero-subtitle">Test jQuery UI autocomplete functionality with static data.</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="section-header">
        <div>
          ...
          <p class="section-subtitle">Type to see autocomplete suggestions</p>
        </div>
      </div>
      ...
      <div style="background:#fff;border:1px solid #e5e7eb;border-radius:14px;padding:20px;">
        ...
        <div style="margin-top:16px;display:flex;gap:12px;">
          <a href="./search/" class="btn-primary">Go to Search</a>
    ...
    $(document).ready(function() {
      ...
      $("#event-search").autocomplete({
        ...
        select: function(event, ui) {
          $("#result").html("<p style='color:#059669;font-weight:600;'>You selected: " + ui.item.value + "</p>");
        }
      });
