	...
	<section class="hero">
		...
		<div class="container hero-content">
			...
			<p class="hero-subtitle">
				Here you'll find all legal information about EventLink.
			</p>
		</div>
	</section>
		...
		<div class="container">
			...
			<div>
				<p>
					...
					<a href="mailto:ntaha@constructor.university">ntaha<span> at
						</span>constructor.university</a><br>
					<a href="mailto:ayesfi@constructor.university">ayesfi<span> at
						</span>constructor.university</a><br>
					<a href="mailto:barystanov@constructor.university">barystanov<span> at
						</span>constructor.university</a> <br>
					<a href="mailto:ysarka@constructor.university">ysarka<span> at
						</span>constructor.university</a>
				</p>
				...
				<p>This website is student lab work and does not necessarily reflect Constructor University opinions.
					...
					does not contain contents which is illegal wrt. German jurisdiction. However, as we have no
					influence on
					such contents, this may change without our notice. Therefore we deny any responsibility for the
					websites
			...
			<div class="footer-grid">
				<div class="footer-column">
					...
					<p class="footer-description">
						Connecting you with unforgettable experiences. Discover, book, and enjoy the best events around
						the world.
					</p>
